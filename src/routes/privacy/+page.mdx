...
Because our instance is self-hosted, under no circumstances will any of this data be shared with third parties. We are also GDPR, CCPA, & cookie law compliant due to the fact that we do not employ the use cookies.
...
This information is stored by us only. We will never share the above information with any third parties. The only third parties affiliated with our volunteer application process are legal consultation & our outsourced background checking service.
